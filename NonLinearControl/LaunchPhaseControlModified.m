...
%Initial condition:
x=0; y=0; xdot=0; ydot=100; phi=pi/2; phidot=-3.8*pi/180; u=100; w=-3.8*pi/180; beta=0;
...
% Target parking pose:
xP=3500; yP=3000; phiP=0; % we will use it in formulas for e and alpha
...
%           gamma*h*theta;
        wRef = k*alpha + gamma*u*sin(alpha)*(alpha+h*theta)/(alpha*e);
    else
